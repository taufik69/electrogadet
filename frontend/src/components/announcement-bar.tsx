    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `(function(){var b=document.getElementById("announcement-bar");if(b&&localStorage.getItem("nordvolt-announcement-dismissed")===b.dataset.announcementId){b.remove()}})()`,
        }}
      />
      <div
        id="announcement-bar"
