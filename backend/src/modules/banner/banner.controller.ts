...
import { createBannerSchema, updateBannerSchema, listBannersQuerySchema } from "./banner.validation.js"
...
export const bannerController = {
  async list(req: Request, res: Response) {
    ...
    const { data, nextCursor, hasMore } = await bannerService.listBanners(cursor, limit, { includeInactive })
  ...
  async create(req: Request, res: Response) {
    ...
    const banner = await bannerService.createBanner(parsed.data)
  ...
  async update(req: Request<{ id: string }>, res: Response) {
    ...
    const banner = await bannerService.updateBanner(req.params.id, parsed.data)
